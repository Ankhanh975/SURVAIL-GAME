...
def tank(x, y, turPos):
    ...
    pygame.draw.line(gameDisplay, blue, (x, y),
...
def fireShell(xy, tankx, tanky, turPos, gun_power, xlocation, barrier_width, randomHeight, enemyTankX, enemyTankY):
    ...
    while fire:
        ...
        pygame.draw.circle(
            gameDisplay, red, (startingShell[0], startingShell[1]), 5)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen(
            "The more enemies you destroy, the harder they get.", wheat, 110)
        message_to_screen("Created by :- Amar Kumar", wheat, 280)
        # message_to_screen("Press C to play, P to pause or Q to quit",black,180)

        button("Play", 150, 500, 100, 50, wheat,
               light_green, action="play", size="vsmall")
        button("Controls", 350, 500, 100, 50, wheat,
               light_yellow, action="controls", size="vsmall")
        button("Quit", 550, 500, 100, 50, wheat,
