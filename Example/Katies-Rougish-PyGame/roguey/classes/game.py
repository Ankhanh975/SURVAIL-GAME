...
from roguey.classes.player import Inventory, Player
from roguey.classes.combat import Combat
from roguey.classes.gamescreen import GameScreen
...
class Game(object):
    ...
    def __init__(self):
        ...
        self.screen.draw_screen_layers(
            player_stats=self.player_stats, map=self.map)
