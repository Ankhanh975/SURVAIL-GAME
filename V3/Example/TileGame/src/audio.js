...
(function () {
  ...
  var SUPPORT_AUDIO_OGG =
    audio_supported &&
    !!audio_supported.canPlayType('audio/ogg; codecs="vorbis');
  var SUPPORT_AUDIO_MP3 =
    audio_supported && !!audio_supported.canPlayType("audio/mpeg");
  var SUPPORT_AUDIO_WAV =
    audio_supported && !!audio_supported.canPlayType('audio/wav; codecs="1"');

  var AudioHandler = function () {
    var format = null;
    if (SUPPORT_AUDIO) {
      format = SUPPORT_AUDIO_OGG
        ? "ogg"
        : SUPPORT_AUDIO_MP3
        ? "mp3"
        : SUPPORT_AUDIO_WAV
